...
@endsection
@section('content')
<form enctype="multipart/form-data" method="POST" action="{{ route('admin.modulo.UpdateExercicio', ['id' => $id])}}" class="d-flex col-12 p-0 flex-column">
    {{ csrf_field() }}
    <h1 class="m-0 text-dark">Editar Exercicio - Aula {{$nome_aula}}</h1>
<div class="card-body">
